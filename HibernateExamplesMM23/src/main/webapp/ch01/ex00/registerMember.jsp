...
<H2>加入會員</H2>
<small>
     呼叫ch01.ex00.dao.MemberDao介面的save()進行新增<BR>
     (實作類別為ch01.ex00.dao.impl.MemberDaoImpl_Hibernate.java)
</small>
<hr>

<form action="<c:url value='/ch01/ex00/registerMember.do' />" method="POST">
    <table>
         <tr>
