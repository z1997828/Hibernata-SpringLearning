...
<H2>加入會員</H2>
<small>
     呼叫ch05.ex00.dao.MemberDao介面的save()進行新增<BR>
     (實作類別為ch05.ex01.dao.impl.MemberRepositoryInMemory.java)
</small>
<hr>

<form action="<c:url value='/ch05/ex01/registerMember.do' />" method="POST">
...
<p>
<small><a href="<c:url value='/ch05/index.jsp' />">回首頁</a></small>
</p>
</div>
</body>
</html>
