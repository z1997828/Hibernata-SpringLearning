...
public class InitDataServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ProductEntityService productService = webApplicationContext.getBean(ProductEntityService.class);
		...
		request.setAttribute("InitSuccess", "資料初始化完畢");
		RequestDispatcher rd = request.getRequestDispatcher("/ch06/index.jsp");
