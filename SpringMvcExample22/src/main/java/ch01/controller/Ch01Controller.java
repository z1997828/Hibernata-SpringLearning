...
public class Ch01Controller {
	...
	@RequestMapping(value="/ch01/serverTime",method=RequestMethod.GET)
	public String serverTime(Model model,
			@RequestParam(required=false,defaultValue="Asia/Taipei"	) String timeZone) {
		...
		model.addAttribute("timezome",timeZone);
